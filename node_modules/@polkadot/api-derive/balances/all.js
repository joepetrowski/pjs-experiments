...
function calcBalances(_ref) {
  ...
  const vestedBalance = (0, _types.createType)('Balance', perBlock.mul(bestNumber));
  ...
  const availableBalance = (0, _types.createType)('Balance', (0, _util.bnMax)(new _bn.default(0), isVesting && floating.gt(vestedBalance) ? vestedBalance : floating));
  return {
    accountId,
    accountNonce,
    availableBalance,
