...
describe('Block', () => {
  ...
  it('has a valid toRawType', () => {
    expect(new _Block.default().toRawType()).toEqual( // each of the containing structures have been stringified on their own
    JSON.stringify({
  ...
  it('re-encodes digest items correctly', () => {
    const digest = new _Block.default(_SignedBlock.default.result.block).header.digest;
