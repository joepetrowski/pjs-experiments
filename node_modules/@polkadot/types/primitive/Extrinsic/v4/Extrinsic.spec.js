...
const decorated = new _metadata.default(_static.default);
...
describe('ExtrinsicV4', () => {
  ...
  it('creates a unsigned extrinsic', () => {
    expect(new _Extrinsic.default(decorated.tx.balances.transfer(keyring.bob.publicKey, 6969)).toHex()).toEqual('0x' + '0600' + // balance.transfer
    'ff' + 'd7568e5f0a7eda67a82691ff379ac4bba4f9c9b859fe779b5d46363b61ad2db9' + 'e56c');
  });
  it('creates a signed extrinsic', () => {
    expect(new _Extrinsic.default(decorated.tx.balances.transfer(keyring.bob.publicKey, 6969)).sign(keyring.alice, {
