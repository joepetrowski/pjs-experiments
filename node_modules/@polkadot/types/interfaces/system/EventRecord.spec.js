...
var _static = _interopRequireDefault(require("@polkadot/metadata/Metadata/v0/static"));
...
var _Event = _interopRequireDefault(require("../../primitive/Generic/Event"));
...
describe('EventRecord', () => {
  describe('EventRecord_0_76', () => {
    ...
    it('decodes correctly', () => {
      const records = (0, _create.createType)('Vec<EventRecord>', _EventRecord.default.params.result.changes[0][1]);
      const er = records[0];
  ...
  describe('EventRecord (current)', () => {
    ...
    it('decodes older eventrecord correctly', () => {
      const records = (0, _create.createType)('Vec<EventRecord>', _EventRecord.default.params.result.changes[0][1], true);
      const er = records[0];
      expect(er.phase.type).toEqual('ApplyExtrinsic');
    });
    it('decodes eventrecord with topics correctly', () => {
      const hex = _EventRecord2.default.params.result.changes[0][1];
      const records = (0, _create.createType)('Vec<EventRecord>', hex, true);
      const er = records[0];
      expect(er.phase.type).toEqual('ApplyExtrinsic');
