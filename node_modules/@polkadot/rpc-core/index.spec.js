...
describe('Api', () => {
  ...
  it('creates an instance with all sections', () => {
    const rpc = new _.default(new _mock.default());
    expect(Object.keys(rpc).filter(key => !key.startsWith('_'))).toEqual(['provider', 'mapping', 'sections', 'account', 'author', 'chain', 'contracts', 'payment', 'rpc', 'state', 'system']);
  });
