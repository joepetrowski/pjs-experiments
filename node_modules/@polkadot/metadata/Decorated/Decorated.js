...
class Decorated {
  constructor(value) {
    ...
    this.query = void 0;
    this.tx = void 0;
    this.metadata = value instanceof _Metadata.default ? value : new _Metadata.default(value);
    this.tx = (0, _fromMetadata2.default)(this.metadata);
    this.query = (0, _fromMetadata3.default)(this.metadata);
    this.consts = (0, _fromMetadata.default)(this.metadata);
  }
