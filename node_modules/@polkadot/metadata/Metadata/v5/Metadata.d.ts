import { EventMetadataV5, FunctionMetadataV5 } from '@polkadot/types/interfaces/metadata';
 ...
 */
export declare class ModuleMetadataV5 extends Struct {
...
export default class MetadataV5 extends Struct implements MetadataInterface<ModuleMetadataV5> {
     ...
     */
    get modules(): Vec<ModuleMetadataV5>;
}
