...
class ApiBase extends _Init.default {
  ...
  createType(type) {
    ...
    return (0, _types.createType)(type, ...params);
  }
  /**
  ...
  findCall(callIndex) {
    return _types.GenericCall.findFunction((0, _util.u8aToU8a)(callIndex));
  }
  /**
  ...
  registerTypes(types) {
    types && (0, _types.getTypeRegistry)().register(types);
  }
  /**
  ...
  async sign(signer, data) {
    ...
    if ((0, _util.isString)(signer)) {
      var _this$_rx$signer;

      (0, _util.assert)((_this$_rx$signer = this._rx.signer) === null || _this$_rx$signer === void 0 ? void 0 : _this$_rx$signer.signRaw, 'No signer exists with a signRaw interface');
      return (await this._rx.signer.signRaw(_objectSpread({
        type: 'bytes'
      }, data, {
        address: signer
      }))).signature;
    ...
    return (0, _util.u8aToHex)(signer.sign((0, _util.u8aToU8a)(data.data)));
  }
